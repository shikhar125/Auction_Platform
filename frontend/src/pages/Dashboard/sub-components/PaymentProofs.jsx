  ...
  return (
    <>
      <div className="overflow-x-auto">
        <table className="min-w-full bg-card mt-5">
          ...
          <tbody className="text-foreground">
            {paymentProofs.length > 0 ? (
                ...
                return (
                  <tr key={index}>
                    ...
                    <td className="flex items-center py-4 justify-center gap-3">
                      <button
                        className="bg-primary text-primary-foreground py-1 px-3 rounded hover:bg-primary/80 transition-all duration-300"
                        onClick={() => handleFetchPaymentDetail(element._id)}
                      >
                        Update
                      </button>
                      <button
                        className="bg-destructive text-destructive-foreground py-1 px-3 rounded hover:bg-destructive/80 transition-all duration-300"
              ...
              <tr className="text-center text-xl text-muted-foreground py-3">
  ...
  return (
    <>
      <section
        ...
        }  left-0 w-full transition-all duration-300 h-full bg-black/50 flex items-end`}
      >
        <div className="bg-card h-fit transition-all duration-300 w-full">
            ...
            <form className="flex flex-col gap-5 my-5">
              <div className="flex flex-col gap-3">
                ...
                <input
                  ...
                  className="text-xl px-1 py-2 bg-transparent border-[1px] border-border  rounded-md focus:outline-none  text-muted-foreground"
                />
              </div>
              <div className="flex flex-col gap-3">
                ...
                <input
                  ...
                  className="text-xl px-1 py-2 bg-transparent border-[1px] border-border  rounded-md focus:outline-none"
                />
              </div>
              <div className="flex flex-col gap-3">
                ...
                <select
                  ...
                  className="text-xl px-1 py-2 bg-transparent border-[1px] border-border  rounded-md focus:outline-none text-foreground"
                >
              ...
              <div>
                <Link
                  ...
                  className="bg-primary flex justify-center w-full py-2 rounded-md text-primary-foreground font-semibold text-xl transition-all duration-300 hover:bg-primary/80"
                  target="_blank"
                >
                  Payment Proof (SS)
                </Link>
              ...
              <div>
                <button
                  type="button"
                  className="bg-secondary flex justify-center w-full py-2 rounded-md text-secondary-foreground font-semibold text-xl transition-all duration-300 hover:bg-secondary/80"
