  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        ...
        <div>
          <h3
            className={`text-foreground text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl`}
          >
            Our Mission
          </h3>
          <p className="text-xl text-foreground">
        ...
        <div>
          ...
          <ul className="list-inside">
            {values.map((element) => {
              return (
                <li className="text-xl text-foreground mb-2" key={element.id}>
        ...
        <div>
          ...
          <p className="text-xl text-foreground">
            Founded by CodeWithZeeshu, BidStorm was born out of a passion for
