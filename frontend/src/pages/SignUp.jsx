          ...
          >
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <div className="flex flex-col sm:flex-1">
                <label className="text-[16px] text-muted-foreground">Full Name</label>
                <input
                  type="text"
                  value={userName}
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <div className="flex flex-col sm:flex-1">
                <label className="text-[16px] text-muted-foreground">Phone</label>
                <input
                  type="number"
                  value={phone}
              ...
              <div className="flex flex-col sm:flex-1">
                <label className="text-[16px] text-muted-foreground">Address</label>
                <input
                  type="text"
                  value={address}
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <div className="flex flex-col sm:flex-1">
                <label className="text-[16px] text-muted-foreground">Role</label>
                <select
                  value={role}
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  <select
                    ...
                    className="text-[16px] py-2 bg-transparent border-b-[1px] border-b-border focus:outline-none sm:flex-1"
                    disabled={role === "Bidder" || role === "Super Admin"}
                  >
              ...
              <div>
                <label className="text-[16px] text-muted-foreground font-semibold">
            ...
            <button
              className="bg-primary text-primary-foreground w-[420px] font-semibold hover:bg-primary/80 transition-all duration-300 text-xl py-2 px-4 rounded-md mx-auto lg:w-[640px] my-4"
              type="submit"
              disabled={loading}
            >
              {loading && "Registering..."}
