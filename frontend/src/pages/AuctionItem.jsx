        ...
        {loading ? (
          ...
          <div className="flex gap-4 flex-col lg:flex-row">
            <div className="flex-1 flex flex-col gap-3">
              <div className="flex gap-4 flex-col lg:flex-row">
                <div className="bg-card w-[100%] lg:w-40 lg:h-40 flex justify-center items-center p-5">
                  <img
              ...
              <hr className="my-2 border-t-[1px] border-t-border" />
            ...
            <div className="flex-1">
              <header className="bg-secondary py-4 text-[24px] font-semibold px-4">
                BIDS
              </header>
              <div className="bg-card px-4 min-h-fit lg:min-h-[650px]">
                {auctionBidders &&
