  ...
  return (
    <>
      ...
      <div className="bg-card mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
          ...
          >
            <h3 className={`text-primary text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl`}>Upload Payment Proof</h3>
            <div className="flex flex-col gap-2">
              <label className="text-[16px] text-foreground">Amount</label>
              <input
                type="number"
                value={amount}
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[16px] text-foreground">Comment</label>
              <textarea
                value={comment}
                onChange={(e) => setComment(e.target.value)}
                rows={7}
                className="text-[16px] py-2 bg-transparent border-[1px] rounded-md px-1 border-border focus:outline-none"
              />
            </div>
              <button
