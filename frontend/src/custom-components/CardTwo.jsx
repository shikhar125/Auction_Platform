...
const CardTwo = ({ imgSrc, title, startingBid, startTime, endTime, id }) => {
  ...
  return (
    <>
      <div className="basis-full bg-card rounded-md group sm:basis-56 lg:basis-60 2xl:basis-80">
        <img
          src={imgSrc}
          alt={title}
        ...
        <div className="px-2 pt-4 pb-2">
          ...
          <div className="flex flex-col gap-2 mt-4">
            <Link
              className="bg-secondary text-secondary-foreground text-center text-xl px-4 py-2 rounded-md transition-all duration-300 hover:bg-secondary/80"
              to={`/auction/details/${id}`}
            >
              View Auction
            </Link>
            <button
              className="bg-destructive text-destructive-foreground text-center text-xl px-4 py-2 rounded-md transition-all duration-300 hover:bg-destructive/80"
            ...
            <button
              ...
              className="bg-primary text-primary-foreground text-center text-xl px-4 py-2 rounded-md transition-all duration-300 hover:bg-primary/80"
            >
              Republish Auction
            </button>
          </div>
